...
<head>
    ...
    <title>Gráfico de Saídas por Mês e Ano</title>
    ...
    $sqlDia = "SELECT DATE_FORMAT(data, '%Y-%m') AS mes, valor FROM entradas";
    ...
    foreach ($somaMeses as $mes => $valor) {
        $data[] = [$mes, $valor];
    }
