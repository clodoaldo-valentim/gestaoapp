...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE materiais SET nome = :nome, descricao = :descricao, quantidade = :quantidade, 
...
<div class="container">
    ...
    <form method="POST">
        ...
        <div class="input-group mb-3">
            <input type="number" class="form-control" name="quantidade" value="<?= htmlspecialchars($material['quantidade']) ?>" required>
        </div><br>
        <div class="input-group mb-3">
