...
<head>
    ...
    <title>Gráfico de Saídas por Detalhe</title>
    ...
    $sqlDia = "SELECT detalhes, valor FROM entradas";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (isset($somaDetalhes[$detalhe])) {
            $somaDetalhes[$detalhe] += $valor;
        } else {
            $somaDetalhes[$detalhe] = $valor;
        }
    }

    foreach ($somaDetalhes as $detalhe => $valor) {
        $data[] = [$detalhe, $valor];
    }
